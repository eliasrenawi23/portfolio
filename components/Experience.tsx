                ...
                <div className="space-y-4 sm:space-y-8">
                    {experiencesData.map((item, index) => (
                        <motion.div
                            ...
                            viewport={{ once: true }}
                        >
                            {/* Timeline Icon - Hidden on very small screens */}
                            <div className="absolute left-0 sm:left-4 top-4 hidden sm:flex w-8 h-8 items-center justify-center rounded-full bg-white dark:bg-gray-800 border-2 border-indigo-500 shadow-lg z-10">
                            ...
                            {/* Content Card */}
                            <div className="glass-card p-4 sm:p-6 hover:shadow-xl transition-all duration-300 group">
                                {/* Date Badge */}
                                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-1 sm:gap-2 mb-2 sm:mb-3">
                                    ...
                                    <span className="inline-flex items-center self-start px-2 sm:px-3 py-1 rounded-full text-xs font-medium bg-gradient-to-r from-indigo-500/10 to-purple-500/10 text-indigo-700 dark:text-indigo-300 border border-indigo-200/50 dark:border-indigo-500/30">
                                        {item.date}
                                    </span>
                                </div>
                                
                                {/* Location */}
                                <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 mb-2 sm:mb-3 flex items-center gap-1">
